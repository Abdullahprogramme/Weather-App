...
const Footer = () => (
    <footer className="border-t-2 border-[#222831] text-center font-bold text-[#7AA2E3] p-2 flex flex-row justify-center items-center bg-[#222831] mx-auto w-screen space-x-20"
